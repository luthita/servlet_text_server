...
<section>
	...
	<div class="d-flex border border-success p-3">
			...
			%>
		<img src=<%= item.get("thumbnail") %> alt="IU" width="20%">
		<div class="ml-3">
			
			<h4><%= title%></h4>
			<span class="text-success font-weight-bold"><%= item.get("singer") %></span><br>
			<br>
			<span class="text-secondary">앨범	:<%= item.get("album")  %></span><br>
			<span class="text-secondary">재생시간	:<%= item.get("time")  %></span><br>
			<span class="text-secondary">작곡가	:<%= item.get("composer")  %></span><br>
			<span class="text-secondary">작사가	:<%= item.get("lyricist")  %></span><br>
