...
<section class="contents">
	...
	<div class="singer-info d-flex mt-4 border border-success p-3">
		<div class="singer-photo mr-4">
			<img src="<%= target.get("photo") %>" alt="가수 이미지" width="150px">
		</div>
		<div class="singer-info">
			<span class="text-success font-weight-bold"><%= target.get("singer") %></span><br>
			<br>
			<span class="text-secondary">앨범	:<%= target.get("album")  %></span><br>
			<span class="text-secondary">재생시간	:<%= target.get("time")  %></span><br>
			<span class="text-secondary">작곡가	:<%= target.get("composer")  %></span><br>
			<span class="text-secondary">작사가	:<%= target.get("lyricist")  %></span><br>
		</div>
	</div>
